...
// TEST
gulp.task("test", gulp.series(mode, clear, checkjs, checkcss, html, dialog, sprite, vendors, styleguidejs, styleguidecss, js, css, injectscripts, move, sprite, meta, a11ycheck, zipassets, svg, raster, clean, sync));


// BUILD
gulp.task("build", gulp.series(clear, checkjs, checkcss, html, dialog, sprite, injectfullstory, injectga, injectgtm, injectwebfontloader, vendors, styleguidejs, styleguidecss, js, css, move, meta, a11ycheck, injectscripts, fingerprintscripts, svg, fingerprintassets, zipassets, raster, robotstxt, sitemap, clean, sw, minify, preview));
